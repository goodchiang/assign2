  ...
  switch (gameState){
    ...
    case GAME_RUN:
        ...
        // -------------------------------
         ...
         //car1 move
         leftCar1X += speed*(random(2)+0.5);
         if (leftCar1X > width){
             leftCar1X = 0;
         }
         image(imgLeftCar1, leftCar1X, leftCar1Y);  
         //car2 move
         leftCar2X += speed*(random(2)+0.5);
         if(leftCar2X > width){
           leftCar2X = 0;
         }
         image(imgLeftCar2, leftCar2X, leftCar2Y);  
         //car3 move
         rightCar1X -= speed*(random(2)+0.5);
         if(rightCar1X < 0){
           rightCar1X = width;
         }
         image(imgRightCar1, rightCar1X, rightCar1Y);
         //car4 move
         rightCar2X -= speed*(random(2)+0.5);
         if(rightCar2X < 0){
           rightCar2X = width;
         }
         ...
         // car1 hitTest
         if(frogCX > leftCar1X &&
            frogCX < leftCar1X + leftCar1W &&
            frogCY > leftCar1Y &&
            frogCY < leftCar1Y + leftCar1H){
              currentTime = millis();
         ...
         // car2 hitTest
         if(frogCX > rightCar1X &&
            frogCX < rightCar1X + rightCar1W &&
            frogCY > rightCar1Y &&
            frogCY < rightCar1Y + rightCar1H){
              currentTime = millis();
              image(imgDeadFrog,frogX,frogY);
              life--;
              gameState = FROG_DIE;
         ...
         // car3 hitTest
         if(frogCX > leftCar2X &&
            frogCX < leftCar2X + leftCar2W &&
            frogCY > leftCar2Y &&
            frogCY < leftCar2Y + leftCar2H){
              currentTime = millis();
              image(imgDeadFrog,frogX,frogY);
              life--;
              gameState = FROG_DIE;
         ...
         // car4 hitTest
         if(frogCX > rightCar2X &&
            frogCX < rightCar2X + rightCar2W &&
            frogCY > rightCar2Y &&
            frogCY < rightCar2Y + rightCar2H){
              currentTime = millis();
              image(imgDeadFrog,frogX,frogY);
              life--;
              gameState = FROG_DIE;
